...
drop function public.submit_wish_atomic(
  text,
  public.wish_visibility,
  public.wish_locale,
  text,
...
alter table public.wishes
  add column nickname text check (nickname is null or char_length(nickname) <= 40);

create function public.submit_wish_atomic(
  p_message text,
  p_nickname text,
